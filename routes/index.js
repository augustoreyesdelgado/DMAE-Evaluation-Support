...
router.use('../storage', express.static(__dirname + 'storage'));
...
router.post('/filterrecords', async (req, res)=>{
...
//Actualizar usuario
router.post('/updateuserd', async (req, res)=>{
...
//Actualizar paciente
router.post('/updatepatientsd', async (req, res)=>{
        const datos={
        name : req.body.nameP,
...
//Registro de reporte
router.post('/registroreporte', async (req, res)=>{
...
//Eliminar reporte
router.post('/eliminarreporte', async (req, res)=>{
...
//Eliminar pacientes
router.post('/eliminarpacientes', async (req, res)=>{
    console.log(req.body.idP2);
